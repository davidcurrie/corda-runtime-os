...
import net.corda.internal.serialization.model.LocalTypeInformation.AMap
...
private inline val Class<*>.isAbstractClass: Boolean get() = Modifier.isAbstract(modifiers)
